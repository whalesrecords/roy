...
function MaintenanceOverlay() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-app/95 backdrop-blur-sm flex items-center justify-center">
      <div className="text-center px-8 max-w-md">
        {/* Animated logo/icon */}
        <div className="mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-accent-soft animate-pulse">
