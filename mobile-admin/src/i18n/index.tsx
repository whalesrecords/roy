...
const FR: Dict = {
  ...
  'contributors.title': 'Répartition par titre',
  'contributors.subtitle': 'Compositeurs, musiciens… par titre',
  'contributors.add': 'Ajouter une personne',
  'contributors.name': 'Nom',
  'contributors.pct': 'Part %',
  'contributors.save': 'Enregistrer',
  'contributors.empty': 'Aucun titre trouvé pour cet album',
  'contributors.whole': 'Tout le contrat',
  'contributors.none': 'Aucun contributeur',
  'role.composer': 'Compositeur',
  'role.author': 'Auteur',
  'role.performer': 'Interprète',
  'role.musician': 'Musicien',
  'role.producer': 'Producteur',
  'role.arranger': 'Arrangeur',
  ...
  'cform.type': 'Type',
  'cform.name': 'Nom',
  'cform.artistName': 'Nom affiché (ex : Mondial Toboggan)',
  'cform.artistLink': 'Lier à un artiste (optionnel)',
  'cform.share': 'Part %',
...
const EN: Dict = {
  ...
  'contributors.title': 'Split per track',
  'contributors.subtitle': 'Composers, musicians… per track',
  'contributors.add': 'Add a person',
  'contributors.name': 'Name',
  'contributors.pct': 'Share %',
  'contributors.save': 'Save',
  'contributors.empty': 'No track found for this album',
  'contributors.whole': 'Whole contract',
  'contributors.none': 'No contributor',
  ...
  'cform.type': 'Type',
  'cform.name': 'Name',
  'cform.artistName': 'Display name (e.g. Mondial Toboggan)',
  'cform.artistLink': 'Link to an artist (optional)',
  'cform.share': 'Share %',
