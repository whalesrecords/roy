    ...
    <div className="min-h-screen bg-background safe-top safe-bottom">
      ...
      <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-md border-b border-divider">
        <div className="px-4 py-3 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-secondary-500">Historique des versements</p>
          </div>
        </div>
      </header>
      ...
      <main className="px-4 py-4 pb-24 space-y-6">
        ...
        <div className="bg-gradient-to-br from-success to-success/80 rounded-2xl p-5 text-white">
          <p className="text-white/70 text-sm mb-1">Total versé</p>
          <p className="text-3xl font-bold">{formatCurrency(totalPaid.toString())}</p>
          <p className="text-white/70 text-sm mt-2">{payments.length} paiement{payments.length > 1 ? 's' : ''}</p>
        </div>
        ...
        <div className="space-y-3">
          ...
          {payments.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-secondary-500">Aucun paiement pour le moment</p>
            </div>
          ) : (
